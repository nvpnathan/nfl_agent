...
def main(write_production_artifact: bool = False) -> None:
    ...
    try:
        ...
        for train_seasons, val_season in FOLDS:
            if write_production_artifact:
                ...
                model_path = str(tmp_dir / f"model_fold_{val_season}.joblib")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run walk-forward backtest. By default uses temp model artifacts."
    )
    parser.add_argument(
    ...
    main(write_production_artifact=args.write_production_artifact)
